  ...
  singular test
      ocamldep .expect_test_generated.eobjs/expect_test_generated.ml.d
        ocamlc .expect_test_generated.eobjs/expect_test_generated.{cmi,cmo,cmt}
      ocamlopt .expect_test_generated.eobjs/expect_test_generated.{cmx,o}
      ocamlopt expect_test_generated.exe
  expect_test_generated expect_test_generated.output
